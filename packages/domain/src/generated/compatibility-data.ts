...
export const COMPATIBILITY = {
  ...
  "customWorkout": {
    ...
    "CYCLING": {
      ...
      "confidence": "confirmed",
      "note": "Outdoor cycle offers all four. Speed carries the current/average axis and both a single value and a range, displayed in km/h. Indoors differs; see indoor.",
      "indoor": {
        "goalTypes": [
          "TIME",
          "OPEN"
        ...
        "confidence": "confirmed",
        "note": "Indoor cycle drops speed and the distance goal. Cadence and power remain."
      }
    },
    ...
    "ROWING": {
      ...
      "confidence": "confirmed",
      "note": "Outdoor rowing keeps the distance goal; indoors it goes.",
      "indoor": {
        "goalTypes": [
          "TIME",
          "OPEN"
  ...
  "customWorkoutUnverifiedActivities": {
    "_note": "All fourteen activities WorkoutKit accepts for custom workouts have now been enumerated against the composer. Nothing is left half-known; the list stays so the validator keeps a home for the next activity that turns up unchecked.",
    "activities": [],
    "confidence": "unknown"
  },
  "singleGoalWorkout": {
